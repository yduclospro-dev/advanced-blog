import { ButtonLinkVariant, ButtonLinkSize } from './buttonLinkTypes';

export const variantStyles: Record<ButtonLinkVariant, string> = {
...
export const sizeStyles: Record<ButtonLinkSize, string> = {
