  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 relative overflow-hidden transition-colors">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-linear-to-br from-sky-400/20 dark:from-sky-400/30 to-blue-600/20 dark:to-blue-600/30 rounded-full blur-3xl animate-pulse"></div>
        <div
          className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-linear-to-tl from-purple-400/15 dark:from-purple-400/20 to-pink-600/15 dark:to-pink-600/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/3 left-1/3 w-96 h-96 bg-linear-to-r from-teal-400/20 dark:from-teal-400/25 to-green-500/20 dark:to-green-500/25 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative z-10">
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
              ...
              <span className="bg-linear-to-r from-sky-500 to-blue-600 dark:from-sky-400 dark:to-blue-500 bg-clip-text text-transparent">qui vous inspirent</span>
            </h1>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card variant="feature" padding="lg">
              <div className="w-12 h-12 bg-linear-to-br from-sky-400 to-blue-500 rounded-xl flex items-center justify-center mb-4 shadow-lg shadow-sky-500/30 dark:shadow-sky-500/50">
            ...
            <Card variant="feature" padding="lg">
              <div className="w-12 h-12 bg-linear-to-br from-purple-400 to-pink-500 rounded-xl flex items-center justify-center mb-4 shadow-lg shadow-purple-500/30 dark:shadow-purple-500/50">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Card variant="feature" padding="lg">
              <div className="w-12 h-12 bg-linear-to-br from-green-400 to-teal-500 rounded-xl flex items-center justify-center mb-4 shadow-lg shadow-green-500/30 dark:shadow-green-500/50">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {!currentUser && (
          <section className="relative py-20">
            <div className="absolute inset-0 bg-linear-to-r from-sky-500/15 dark:from-sky-500/20 to-blue-600/15 dark:to-blue-600/20 backdrop-blur-3xl"></div>
